...
**A continuación se presentan 10 trabajos desarrollados por estudiantes. Los trabajos se presentan agrupados en TEMÁTICAS**:
...
Para acercarse a tales resultados, los estudiantes usaron HTML, SVG, CSS, algo de JavaScript y la ayuda de [Bootstrap](https://getbootstrap.com/).
...
- **Bootstrap**: Un conjunto de herramientas de código abierto para diseño de sitios y aplicaciones web responsivas, que surgió como un marco de trabajo (framework) para fomentar la consistencia en el trabajo de distintos desarrolladores dentro de Twitter.
