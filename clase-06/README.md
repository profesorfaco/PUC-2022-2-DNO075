...
<html lang="es">
    ...
    <body>
        ...
        <script>
            var personajes = [
                { nombre: "Marge", imagen: "https://raw.githubusercontent.com/profesorfaco/dno075-2022-2/main/clase-06/img/marge.svg" },
                { nombre: "Homer", imagen: "https://raw.githubusercontent.com/profesorfaco/dno075-2022-2/main/clase-06/img/homer.svg" },
                { nombre: "Bart", imagen: "https://raw.githubusercontent.com/profesorfaco/dno075-2022-2/main/clase-06/img/bart.svg" },
                { nombre: "Lisa", imagen: "https://raw.githubusercontent.com/profesorfaco/dno075-2022-2/main/clase-06/img/lisa.svg" },
                { nombre: "Maggie", imagen: "https://raw.githubusercontent.com/profesorfaco/dno075-2022-2/main/clase-06/img/maggie.svg" }
            ];
...
**Usaremos sólo uno de los documentos [compartidos en esta carpeta](https://profesorfaco.github.io/dno075-2022-2/clase-06/) de repositorio**: 

**El [`index.html`](https://github.com/profesorfaco/dno075-2022-2/blob/main/clase-06/index.html) que contiene un arreglo con datos del CENSO 2017**. 
...
###### [← CLASE PASADA](https://github.com/profesorfaco/dno075-2022-2/tree/main/clase-05) — [CLASE SIGUIENTE →](https://github.com/profesorfaco/dno075-2022-2/tree/main/clase-07) 
